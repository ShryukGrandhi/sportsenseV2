        ...
        <div className="min-h-screen flex flex-col">
            ...
            <main className="flex-1 flex items-center justify-center px-4">
                <div className="text-center space-y-6 max-w-lg">
                    {/* Icon */}
                    <div className="inline-flex items-center justify-center p-6 rounded-3xl bg-gradient-to-br from-red-500/20 to-rose-600/20 border border-red-500/30">
                    ...
                    <p className="text-lg text-white/50">Major League Baseball</p>

                    {/* Description */}
                    <p className="text-lg text-white/60">
                        In-depth baseball analytics, pitch tracking, and real-time
                        game updates. Advanced sabermetrics and AI commentary.
                    </p>
